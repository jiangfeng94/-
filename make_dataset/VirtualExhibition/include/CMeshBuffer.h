...
namespace scene
{
	...
	public:
		...
		virtual core::stringc getMeshBufferName()
		{
			return MeshBufferName;

		}
		virtual void setMeshBufferName(core::stringc name)
		{
			MeshBufferName = name;

		}

		virtual core::stringc getMaterialName()
		{
			return MaterialName;

		}
		virtual void setMaterialName(core::stringc name)
		{
			MaterialName = name;
